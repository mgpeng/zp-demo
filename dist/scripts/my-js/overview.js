var Overview = (function(){
    ...
    var setRipplePos = function(menuEl,x,y,tl,tweenLabel){
        ...
        tl.add(TweenMax.staggerTo(ripples,0.3,
                {
                    opacity:0.5,
                    yoyo:true,
                    cycle:{
                        boxShadow:[
                                ...
                                '0 0 0 0 #45c2c5,0 0 0 0 rgba(255,255,255,0.4),0 0 0 0 #45c2c5,0 0 0 0 rgba(0,0,0,0.08)',
                                '0 0 80px 400px #45c2c5,0 0 20px 420px transparent,0 0 60px 440px #45c2c5,0 0 10px 460px transparent'
                        ]
                    }        
                },0.1,tweenLabel));
     };
    var rippleMenuBackground = function(x,y,tl,tweenLabel){
        debugger;
        ...
        tl.add(TweenMax.staggerTo(els,0.3,
                {
                    opacity:0.5,
                    yoyo:true,
                    cycle:{ boxShadow:[
                                '0 0 0 0 transparent,0 0 0 0 transparent,0 0 0 0 transparent,0 0 0 0 transparent',
                                '0 0 0 0 #45c2c5,0 0 0 0 rgba(255,255,255,0.4),0 0 0 0 #45c2c5,0 0 0 0 rgba(0,0,0,0.08)',
                                '0 0 180px 1400px #45c2c5,0 0 120px 1420px transparent,0 0 160px 1440px #45c2c5,0 0 110px 1460px transparent'
                        ]}
                },0.1,tweenLabel+'-0.01'));
    };
    var setClickEvent = function(){
        menuList.on('click',function(e){
             ...
             // changeMenuPosToAbsolutePos();
            var tl = new TimelineMax({pause:true,onComplete:doHide});
            var idStr=$(this).attr('id');
            addRippleContainer(this);
            setRipplePos(this,e.clientX,e.clientY,tl,'tweenLabel');
            rippleMenuBackground(e.clientX,e.clientY,tl,'tweenLabel');
